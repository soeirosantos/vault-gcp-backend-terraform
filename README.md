...
where you have your service account configured in the CI/CD pipelines to manage 
your k8s cluster and deploy your applications to kubernetes. Of course, you can 
create rolesets for other purposes with the role granularity you wish.
